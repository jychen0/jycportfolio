    ...
    <div className="tab-container">
      ...
      <div className={`tab-contents ${activeTab === 'skills' ? 'active-tab skills-tab' : ''}`} id="skills">
        <ul className="grid-content-skills">
          ...
          <li><span><b>Tools and Technologies</b></span><br />Google Docs<br />Google Sheets<br />Microsoft 365 Suite Apps<br />Visual Studio<br />Github Desktop<br />Canva</li>
      ...
      <div className={`tab-contents ${activeTab === 'education' ? 'active-tab education-tab' : ''}`} id="education">
        <ul className="grid-content-education">
          <li><span><b>2023 - 2026 Clark University</b></span><br />B.S. in Interactive Media<br />B.S. in Data Science</li>
